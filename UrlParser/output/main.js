...
var $author$project$Main$LangList = function (a) {
	return {$: 'LangList', a: a};
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				if (urlRequest.$ === 'Internal') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								route: A2($elm$core$Debug$log, 'maybeRoute', maybeRoute)
							}),
						A2(
			...
			case 'UrlChange':
				var location = msg.a;
				var loc = A2($elm$core$Debug$log, 'location', location);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							history: A2($elm$core$List$cons, loc.path, model.history)
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var url = msg.a;
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$GoTo('/lang/1'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('lang/1')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick(
								$author$project$Main$GoTo('/lang/?search=sth'))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('?search=sth')
							])),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/lang/')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('go: lang')
							])),
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/lang/1')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('go: lang/1')
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('/lang/?search=sth')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('go: lang/?search=sth')
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$elm$html$Html$text(
						$elm$core$Debug$toString(model.history)),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$elm$html$Html$text(
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		...
		onUrlRequest: $author$project$Main$NewUrl,
